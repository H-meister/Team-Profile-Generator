//This is where I will generate the HTML
...
<body class="bg-teal-500">
    <div class="u-center bg-teal-900">
        <h1 class="text-white">My Team</h1>
    </div>
    <div class = 'row u-center u-gap-2'>
    <div class="card col-4" style="max-width: 250px;">
        <div class="content u-text-center pt-3">
            ...
            <p id="projectname" class="title mt-2 mb-0">${answers.teamManager}</p>
    ...
    <div class="card col-4" style="max-width: 250px;">
        <div class="content u-text-center pt-3">
            ...
            <p id="projectname" class="title mt-2 mb-0">${answers.enName}</p>
            <p>Blazing fast speed you can rely on.</p>
        </div>
    </div>
    <div class="card col-4" style="max-width: 250px;">
        <div class="content u-text-center pt-3">
            ...
            <p id="projectname" class="title mt-2 mb-0">${answers.inName}</p>
            <p>Blazing fast speed you can rely on.</p>
        </div>
    </div>
    </div>
